      ...
      <div class="grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="p-6 sm:p-10 md:p-12 flex flex-col justify-center">
          ...
          <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
            ...
            <!-- Password baru -->
            <div>
              <x-input-label for="password" value="Password Baru" class="text-gray-800 font-bold tracking-wide" />
              <x-text-input
                id="password"
                class="block mt-2 w-full !bg-white border border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 rounded-xl placeholder-gray-400 text-gray-800"
                type="password"
            ...
            <!-- Konfirmasi password -->
            <div>
              <x-input-label for="password_confirmation" value="Konfirmasi Password" class="text-gray-800 font-bold tracking-wide" />
              <x-text-input
